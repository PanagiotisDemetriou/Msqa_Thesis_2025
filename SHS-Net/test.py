...
def parse_arguments():
    ...
    parser.add_argument('--eval_list', type=str, nargs='*',default=[],
    ...
    parser.add_argument('--sparse_patches', type=eval, default=False, choices=[True, False],
...
if __name__ == '__main__':
    ...
    for ckpt_dir in ckpt_dirs:
        ...
        for ckpt_iter in ckpt_iters:
            ...
            # Inference-only mode: no GT normals, so skip evaluation
            if args.eval_list is None or len(args.eval_list) == 0:
                continue

            # Only evaluate if lists were provided
            all_avg_rms, all_avg_rms_o = eval(
