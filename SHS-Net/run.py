...
parser.add_argument('--data_set', type=str, default='PCPNet',
                    choices=['Scannet', 'PCPNet', 'FamousShape', 'FamousShape3k', 'FamousShape5k', 'FamousShape50k', 'WireframePC', 'SceneNN', 'NestPC', 'Semantic3D', 'KITTI_sub'])
...
if FLAGS.mode == 'train':
    ...
    command = 'python SHS-Net/test.py --gpu={} --dataset_root={} --data_set={} --log_root={} --ckpt_dirs={} --ckpt_iters={} --patch_size={} --batch_size={} \
