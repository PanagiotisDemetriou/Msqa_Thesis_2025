...
if __name__ == '__main__':
    ...
    import torch
    torch.hub.set_dir('/lustreFS/data/vcg/pdemetriou//hf_model_cache')
    os.environ['TRANSFORMERS_CACHE'] = '/lustreFS/data/vcg/pdemetriou//hf_model_cache'
    os.environ['HUGGINGFACE_HUB_CACHE'] = '/lustreFS/data/vcg/pdemetriou//hf_model_cache'
